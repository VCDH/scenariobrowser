tinymce.init({ 
	selector: 'textarea',
	plugins: 'link charmap paste table textcolor',
	menu: {
	...
	toolbar: 'bold italic underline striketrough | alignleft aligncenter alignright | bullist numlist | indent outdent | link unlink | forecolor backcolor',
	resize: true,
